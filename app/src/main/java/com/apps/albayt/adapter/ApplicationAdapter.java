...
import com.apps.albayt.databinding.GalleryRowBinding;
...
public class ApplicationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<ProductModel.ProductGalary> list;
    private Context context;
    private LayoutInflater inflater;
    private Fragment fragment;
    private String lang;

    public ApplicationAdapter(Context context, Fragment fragment, String lang) {
    ...
    public void updateList(List<ProductModel.ProductGalary> list) {
        this.list = list;
