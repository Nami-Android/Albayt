...
public class FragmentSuppliersMvvm extends AndroidViewModel {
    ...
    public FragmentSuppliersMvvm(@NonNull Application application) {
        super(application);
    }
    ...
    public void search(String city_id,String query,String lang) {
        ...
        Api.getService(Tags.base_url)
                .searchForSuppliers(city_id,query,lang)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
