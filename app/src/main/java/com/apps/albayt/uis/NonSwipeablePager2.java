...
public class NonSwipeablePager2 extends ViewPager {
    public NonSwipeablePager2(@NonNull Context context) {
        super(context);
        setMyScroll();
    }

    public NonSwipeablePager2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setMyScroll();
    }
