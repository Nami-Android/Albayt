package com.apps.albayt.uis.activity_sign_up_cotractor.fragments;
...
import com.apps.albayt.databinding.FragmentSignUpContractorStep1Binding;
import com.apps.albayt.databinding.FragmentSignUpSupplierStep1Binding;
import com.apps.albayt.model.ContractorSignUpModel;
...
public class FragmentSignUpContractorStep1 extends BaseFragment {
    private SignUpContractorActivity activity;
    private FragmentSignUpContractorStep1Binding binding;
    private ContractorSignUpModel model ;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        activity = (SignUpContractorActivity) context;
    ...
    public static FragmentSignUpContractorStep1 newInstance(String phone_code, String phone) {
        FragmentSignUpContractorStep1 fragment = new FragmentSignUpContractorStep1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_sign_up_contractor_step1, container, false);
    ...
    private void initView() {
        model = new ContractorSignUpModel();
