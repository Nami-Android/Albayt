package com.apps.albayt.uis.activity_home.certificate_module;
...
public class FragmentCertificates extends BaseFragment {
    private HomeActivity activity;
    private FragmentApplicationBinding binding;
    private ApplicationAdapter adapter;
    private ProductModel productModel;

    public static FragmentCertificates newInstance(ProductModel productModel) {
        Bundle bundle = new Bundle();
        bundle.putSerializable("data",productModel);
        FragmentCertificates fragmentApplications = new FragmentCertificates();
    ...
    private void initView() {
        ...
        adapter.updateList(productModel.getProduct_certifictions());
